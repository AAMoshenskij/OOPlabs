...
class Trapez: public Figure {
    ...
    friend std::istream& operator>>(std::istream& is, Trapez& t);
    friend std::ostream& operator<<(std::ostream& os, Trapez& t);
    friend bool operator==(Trapez& s1, Trapez& s2);

public:
    Trapez();
    Trapez(double _x1, double _y1, double _x2, double _y2, double _x3, double _y3);
...
inline std::istream& operator>>(std::istream& is, Trapez& t) {
...
inline std::ostream& operator<<(std::ostream& os, Trapez& t) {
