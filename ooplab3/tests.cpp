...
TEST(TrapezOperatorsOverloads, assign_oper_overload2) {
    Trapez t1(0, 0, 5, 1, 8, -5);
    Trapez t2;
    t1 = t2;
...
TEST(TrapezOperatorsOverloads, cin_oper_overload1) {
    
    Trapez t1;
    std::cin >> t1;
    Trapez t2(-7, 8, 3, 4, 6, -2);
    ASSERT_TRUE(t1 == t2);
}
